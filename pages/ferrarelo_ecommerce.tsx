  ...
  return (
      <div className='text-slate-700 flex flex-col gap-4 w-full h-full'>
        <div className='m-auto w-full h-96 truncate'>
          <Image className='ease-out duration-300 hover:scale-110 hover:rotate-2' placeholder="blur" blurDataURL={"/ferrarelo1-b.jpg"} src={"/ferrarelo1.jpg"} width={"1280"} height={"720"}/>
        </div>
        <div>
        Ferrarelo Ecommerce
        Ecommerce da marca de sapatos Ferrarelo.
        </div>
        <Link href={"/"}>
